...
public final class ChecksumTests {
  ...
  public void calculateFor() {
    assertEquals("sha512:23I/NBoELY3hqoE+/V4C/BdFzL4llIYldRSATi7EvOuypG8eStRCFUlD+el+G8R8OuDt2rfeDAGpxR8VNCpbGQ==", Checksum.calculateFor("abcdefghijklmno".getBytes(UTF_8)));
  }
